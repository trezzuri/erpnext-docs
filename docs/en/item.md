...
* **Shelf Life In Days**: This is for a product [Batch](/docs/en/stock/batch). The number of days after which product batch will be unusable. For example, medicines.
