...
> 
> Note: From version-13 onwards we have introduced immutable ledger which changes the way cancellation of accounting entries works in SOMA. [Learn more here](/docs/en/accounts/articles/immutable-ledger-in-erpnext).
> 
> 
> 
